...
connection.on("loadSizes", function (x, y, bombs) {
    document.getElementById("sizeXinput").value = x;
    document.getElementById("sizeYinput").value = y;
    document.getElementById("bombsCountInput").value = bombs;
});
